...
class Transformer(nn.Module):
    ...
    def decode(self, encoder_output, src_mask, tgt, tgt_mask):
        ...
        tgt = self.decode(tgt, encoder_output, src_mask, tgt_mask)
        return tgt
...
def build_transform(src_vocab_size: int, tgt_vocab_size: int, src_seq_len: int, tgt_seq_len: int, d_model: int = 512, N: int = 6, h: int = 8, dropout: float = 0.1, d_ff: int = 2048) -> Transformer:
